...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('-c','--charstyle', type=int, default=2,help='style of output')
        self.parser.add_argument('-s','--screen', type=int, default=3,help='size of shell   1:80*24  2:132*43  3:203*55')
